 ...
 */
final class Version20191015111231 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE img ADD CONSTRAINT FK_E01FBE6ABE3DB2B7 FOREIGN KEY (prestataire_id) REFERENCES prestataire (id)');
        $this->addSql('ALTER TABLE img ADD CONSTRAINT FK_E01FBE6ACAC938C2 FOREIGN KEY (prestataire_photos_id) REFERENCES prestataire (id)');
        $this->addSql('ALTER TABLE img ADD CONSTRAINT FK_E01FBE6A4A81A587 FOREIGN KEY (categorie_de_services_id) REFERENCES categorie_de_services (id)');
        ...
        $this->addSql('ALTER TABLE internaute ADD CONSTRAINT FK_6C8E97CC3DA5256D FOREIGN KEY (image_id) REFERENCES img (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE img DROP FOREIGN KEY FK_E01FBE6A4A81A587');
        ...
        $this->addSql('ALTER TABLE img DROP FOREIGN KEY FK_E01FBE6ABE3DB2B7');
        $this->addSql('ALTER TABLE img DROP FOREIGN KEY FK_E01FBE6ACAC938C2');
