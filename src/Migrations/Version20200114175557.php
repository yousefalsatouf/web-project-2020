 ...
 */
final class Version20200114175557 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, code_postal_id INT DEFAULT NULL, localite_id INT DEFAULT NULL, commune_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, adresse_nbr VARCHAR(255) DEFAULT NULL, adresse_rue VARCHAR(255) DEFAULT NULL, banni TINYINT(1) DEFAULT NULL, inscription_conf TINYINT(1) DEFAULT NULL, inscription DATETIME DEFAULT NULL, nb_essais_infructueux INT DEFAULT NULL, type_utilisateur VARCHAR(255) DEFAULT NULL, discr VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649B2B59251 (code_postal_id), INDEX IDX_8D93D649924DD2B5 (localite_id), INDEX IDX_8D93D649131A4F72 (commune_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
